...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="#" class="w3-bar-item w3-button w3-padding-16 w3-hide-large w3-dark-grey w3-hover-black" onclick="w3_close()" title="close menu"><i class="fa fa-remove fa-fw"></i>  Close Menu</a>
     <a href="home.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-pencil-square" aria-hidden="true"></i>  Home</a>
     <a href="#profile" class="editprofile w3-bar-item w3-button" data-toggle="modal" data-id='<?php echo $admin['id']; ?>'>  <i class="fa fa-user"></i>Edit Profile</a>
         <a href="updates.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-pencil-square" aria-hidden="true"></i>  Write</a>
  </div>
</nav>
