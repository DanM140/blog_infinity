            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="unpublish.php">
                ...
                <div class="text-center">
                    <p>De-Activate the Article</p>
                    <h2 class="bold name"></h2>
                </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
              <button type="submit" class="btn btn-danger btn-flat" name="unpublish"><i class="fa fa-trash"></i> De-Activate</button>
              </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="publish_delete.php">
                <input type="hidden" class="prodid" name="id">
                <div class="text-center">
                    <p>Delete</p>
                    <h2 class="bold name"></h2>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="publish_edit.php">
                <input type="hidden" class="prodid" name="id">
