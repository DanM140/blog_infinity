	...
	$firstname = $_POST['firstname'];
		...
		if ($row['numrows']>0) {
			...
			try {
				...
				$stmt->execute(['email'=>$email, 'password'=>$password, 'firstname'=>$firstname, 'lastname'=>$lastname, 'address'=>$address, 'contact'=>$contact, 'photo'=>$filename, 'status'=>1, 'type'=>$type,'created_on'=>$now]);
